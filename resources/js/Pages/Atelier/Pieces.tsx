...
export default function Pieces({ auth, pieces, piecesRef }:PiecesProps) {
    ...
    // Fonction pour filtrer les pièces en fonction de la recherche
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="mb-4 flex justify-between items-center">
                            ...
                            />
                            <button className="border border-solid border-black text-black px-4 py-2 rounded-md hover:bg-gray-100" onClick={() => alert("Ajouter une pièce")}>
                                Ajouter une pièce
                            </button>
                        </div>
